-- ============================================================
-- 088 — o desconto dado em UM item é gravado
--
-- O PDV ganhou desconto por item (F6/F7), mas a venda o descartava:
-- registrar_venda_pdv não gravava nada em erp_venda_itens.desconto_unitario,
-- que existia zerada desde sempre. O desconto aparecia no cupom da tela e
-- sumia no banco — e aí o relatório de vendas mostrava um desconto total
-- que não batia com a soma das linhas.
--
-- A coluna é POR UNIDADE, como o nome diz; o balcão informa o desconto da
-- linha inteira, então é dividido pela quantidade na hora de gravar.
-- `subtotal` já chega líquido do front.
-- ============================================================
