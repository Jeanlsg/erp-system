...
import {
  ...
  Flag,
  Upload,
  ChevronDown, ExternalLink, Gauge, Keyboard, Landmark, MonitorSmartphone, Eraser,
} from "lucide-react";
...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { title: "Frente de Caixa", url: "/pdv", icon: ScanBarcode, perm: "pdv.usar" },
      ...
      { title: "ExApp Pedidos", url: "/exapp-pedidos", icon: MessageSquare, perm: "venda.criar" },
      {
        ...
        children: [
          ...
          { title: "Promissória", url: "/promissoria", icon: ScrollText },
        ],
      },
      {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: "Estoque Produtos", url: "/produtos-estoque-lotes", icon: Package, perm: "produto.ver" },
          ...
          { title: "Importar NF-e", url: "/compras/importar-nfe", icon: Upload, perm: "compra.criar" },
          { title: "Kits & Combos", url: "/kits", icon: PackagePlus, perm: "produto.ver" },
          { title: "Serviços Oferecidos", url: "/gestao/servicos", icon: Wrench },
          { title: "Agenda Telefônica", url: "/gestao/agenda-telefonica", icon: Smartphone },
          { title: "Documentos Administrativos", url: "/gestao/documentos", icon: FolderTree },
      ...
      },
      {
        ...
        children: [
          ...
          { title: "Encaminhar para Protesto", url: "/gestao/encaminhar-protesto", icon: Send },
          { title: "Recomendo/Não Recomendo", url: "/gestao/recomendacoes", icon: ThumbsUp },
      ...
      },
      {
        ...
        children: [
          { title: "Crediário Próprio", url: "/crediario-proprio", icon: CreditCard },
          { title: "Crediário", url: "/gestao/gerar-crediario", icon: CreditCard },
          { title: "Promissória", url: "/promissoria", icon: ScrollText },
          { title: "Cheque", url: "/gestao/recebimento-cheque", icon: ScrollText },
      ...
      },
      {
        ...
        children: [
          { title: "Consulta Pessoa Física", url: "/gestao/consulta-pessoa-fisica", icon: Users },
          { title: "Consulta Pessoa Jurídica", url: "/gestao/consulta-pessoa-juridica", icon: Building2 },
          { title: "Consulta de Cheque", url: "/gestao/consulta-cheque", icon: ScrollText },
        ],
      },
      {
      ...
      { title: "Painel Gestor", url: "/gestao", icon: LayoutDashboard },
    ],
  },
  {
    label: "Vendas pela Internet",
    items: [
      { title: "iFood", url: "/marketplace-ifood", icon: ShoppingCart },
    ],
  },
  {
    label: "Configurações",
    items: [
      ...
      { title: "Minhas Chaves", url: "/config/minhas-chaves", icon: Key },
      { title: "Acessar meu Contador", url: "/gestao/painel-contador", icon: Calculator },
      { title: "Gerar Código de Barras", url: "/gestao/codigo-barras", icon: Barcode },
      { title: "Downloads e Equipamentos", url: "/equipamentos", icon: Barcode },
      {
      ...
      {
        title: "Links Úteis", url: "", icon: ExternalLink,
        children: [
          { title: "Testar Velocidade", url: "https://fast.com/pt/", icon: Gauge, external: true },
          { title: "Testar Teclado", url: "https://teclado.online/pt/teste.php", icon: Keyboard, external: true },
          { title: "Simples Nacional", url: "http://www8.receita.fazenda.gov.br/SimplesNacional/", icon: Landmark, external: true },
          { title: "Baixar AnyDesk", url: "https://anydesk.com/pt/downloads/windows", icon: MonitorSmartphone, external: true },
          { title: "Limpar histórico (Cache)", url: "https://support.google.com/chrome/answer/95589?hl=pt-BR", icon: Eraser, external: true },
        ],
      },
    ],
  },
