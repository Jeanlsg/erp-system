...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Movimentações (Kardex)", url: "/estoque/movimentacoes", icon: ArrowLeftRight, perm: "produto.ver", badge: "novo" },
      { title: "Inventário / Balanço", url: "/estoque/inventario", icon: Package, perm: "estoque.ajustar", badge: "novo" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Notas Recebidas (SEFAZ)", url: "/fiscal/notas-recebidas", icon: FileText, perm: "compra.criar", badge: "novo" },
      { title: "Escrituração (SPED)", url: "/fiscal/escrituracao", icon: Calculator, perm: "fiscal.emitir", badge: "novo" },
