...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // { title: "Boletos", url: "/gerador-boletos", icon: Barcode }, // desativado: sem provedor contratado — reativar quando houver (convênio bancário)
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Faturamento", url: "/faturamento", icon: FileText, perm: "fiscal.emitir" },
